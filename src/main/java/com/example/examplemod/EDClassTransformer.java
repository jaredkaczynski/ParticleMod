...
public class EDClassTransformer implements IClassTransformer {
    ...
    public byte[] patchClassASM(String name, byte[] bytes, boolean obfuscated) {
        ...
        System.out.println("Particles: targetmethodname " + targetMethodName);
//Our target method
        if (obfuscated == true)
...
//Loop over the instruction set and find the instruction FDIV which does the division of 1/explosionSize
                while (iter.hasNext()) {
                    ...
                    System.out.println("Particles: currentNode " + currentNode);
                    System.out.println("Particles: currentNode " + currentNode.getOpcode());
                    System.out.println("Particles: currentNode " + currentNode.getType());
...
//add your own instruction lists: *USE THE ASM JAVADOC AS REFERENCE*
                        ...
                        System.out.println("Particles: toinject " + toInject.getFirst().getOpcode());
                        System.out.println("Particles: toinject " + toInject.getFirst());
